...
export const plugins: Plugin[] = [
  ...
  },
  {
    ...
    description:
      'Diverse set of physical modeling sources, organic processors, wavetable oscillators, waveshapers, granular synths, and utility modules',
    type: 'Misc',
    frameworks: [],
  },
  {
  ...
  },
  {
    ...
    description:
      'Detect chord names from a MIDI track and display them in a scrolling window during track playback',
    type: 'Misc',
    frameworks: ['JUCE'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Studio-quality reverb using the Dattorro’s figure-of-eight reverb structure',
    type: 'Effect',
    frameworks: ['VSTGUI'],
  },
  {
  ...
  },
  {
    ...
    description:
      "Neural amplifier modeler, LV2 version of Steven Atkinson's NAM plugin",
    type: 'Effect',
    frameworks: [],
  },
  {
  ...
  },
  {
    ...
    description:
      'Performance-oriented filter designed to replace the mid-EQ found in a standard 3-band DJ mixer',
    type: 'Effect',
    frameworks: ['JUCE'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Multitimbral 8-operator FM synth (VST 2.4; Windows, Linux, macOS)',
    type: 'Instrument',
    frameworks: ['VSTGUI'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Audio DSP FX and plugins, mostly for guitar (amp sim) and other FX',
    type: 'Effect',
    frameworks: ['VSTGUI'],
  },
  {
  ...
  },
  {
    ...
    description:
      'VST for streaming sound into Icecast/Shoutcast directly from VST hosts',
    type: 'Effect',
  ...
  },
  {
    ...
    description:
      'Guitar amplifier-style plugin, that uses machine learning for emulating real world hardware',
    type: 'Instrument',
    frameworks: ['JUCE'],
  },
  {
    ...
    description:
      'Guitar pedal-style plugin, that uses machine learning for emulating real world hardware',
    type: 'Effect',
    frameworks: ['JUCE'],
  },
  {
    ...
    description:
      'Real-time audio analysis to allow anyone to quickly set up and experiment with different algorithms',
    type: 'Effect',
    frameworks: ['JUCE'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Spatial audio focused plug-in suite (Ambisonics encoders/decoders, 3-D panners/spatialisers, etc.)',
    type: 'Effect',
    frameworks: ['SAF', 'JUCE'],
  },
  {
    ...
    description:
      'Compressor with side-chain, several detection modes and filters, etc',
    type: 'Effect',
    frameworks: ['JUCE'],
  },
  {
  ...
  },
  {
    ...
    description:
      'Digital distortion targeting VST, VST3, and AU for OS X and Windows',
    type: 'Effect',
  ...
  },
  {
    ...
    description:
      'FM synth based on emulator of YM2413 (OPLL) chip used in Sega Master System and FM-PAC MSX expansion',
    type: 'Instrument',
    frameworks: [],
  },
  {
  ...
  },
  {
    ...
    description:
      'LADSPA/LV2/VST/JACK audio plugins for high-quality processing',
    type: 'Effect',
    frameworks: ['DPF'],
  },
  {
