...
| [musegpt](https://github.com/greynewell/musegpt) | Chat with an AI Assistant running on local open-weights models in your favorite DAW via VST, AAX & AU | Effect | JUCE |
